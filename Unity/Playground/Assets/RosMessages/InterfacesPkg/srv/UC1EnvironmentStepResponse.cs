...
{
    [Serializable]
    public class UC1EnvironmentStepResponse : Message
    {
        ...
        public UC1EnvironmentStepResponse()
        {
        ...
        public UC1EnvironmentStepResponse(BuiltinInterfaces.TimeMsg request_received_timestamp, BuiltinInterfaces.TimeMsg response_sent_timestamp, BuiltinInterfaces.TimeMsg response_received_timestamp, Sensor.CompressedImageMsg compressed_image, UC1AgentStateMsg state)
        {
        ...
        public static UC1EnvironmentStepResponse Deserialize(MessageDeserializer deserializer) => new UC1EnvironmentStepResponse(deserializer);

        private UC1EnvironmentStepResponse(MessageDeserializer deserializer)
        {
        ...
        {
            return "UC1EnvironmentStepResponse: " +
