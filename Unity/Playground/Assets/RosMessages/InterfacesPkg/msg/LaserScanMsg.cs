...
namespace RosMessageTypes.InterfacesPkg
{
    ...
    {
        public const string k_RosMessageName = "interfaces_pkg/LaserScan";
        ...
        public LaserScanMsg(float angle_min, float angle_max, float angle_increment, float range_min, float range_max, float[] ranges)
        {
        ...
        public static LaserScanMsg Deserialize(MessageDeserializer deserializer) => new LaserScanMsg(deserializer);
