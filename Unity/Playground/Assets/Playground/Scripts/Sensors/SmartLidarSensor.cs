...
public class SmartLidarSensor : Sensor {
    
    [HideInInspector] public SmartLidarSensorMsg smartLidarSensorMsg;
    ...
    public override void Initialize() {
        smartLidarSensorMsg = new SmartLidarSensorMsg();
    }

    public override void GetSensorData() {

        // Convert Unity data to ROS message
        smartLidarSensorMsg.angle_min = angleMin;
        smartLidarSensorMsg.angle_max = angleMax;
        smartLidarSensorMsg.angle_increment = _angleIncrement;
        smartLidarSensorMsg.range_min = rangeMin;
        smartLidarSensorMsg.range_max = rangeMax;
        smartLidarSensorMsg.ranges = _ranges;
        smartLidarSensorMsg.tags = _tags;
