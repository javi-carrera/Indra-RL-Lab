...
{
    [Serializable]
    public class UC2EnvironmentResetResponse : Message
    {
        ...
        public UC2EnvironmentResetResponse()
        {
        ...
        public UC2EnvironmentResetResponse(BuiltinInterfaces.TimeMsg request_received_timestamp, BuiltinInterfaces.TimeMsg response_sent_timestamp, BuiltinInterfaces.TimeMsg response_received_timestamp, Sensor.CompressedImageMsg compressed_image, UC2AgentStateMsg state)
        {
        ...
        public static UC2EnvironmentResetResponse Deserialize(MessageDeserializer deserializer) => new UC2EnvironmentResetResponse(deserializer);

        private UC2EnvironmentResetResponse(MessageDeserializer deserializer)
        {
        ...
        {
            return "UC2EnvironmentResetResponse: " +
