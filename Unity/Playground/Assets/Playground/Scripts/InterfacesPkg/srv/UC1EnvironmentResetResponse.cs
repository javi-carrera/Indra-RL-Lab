...
{
    [Serializable]
    public class UC1EnvironmentResetResponse : Message
    {
        ...
        public UC1AgentStateMsg state;

        public UC1EnvironmentResetResponse()
        {
            ...
            this.state = new UC1AgentStateMsg();
        }

        public UC1EnvironmentResetResponse(BuiltinInterfaces.TimeMsg request_received_timestamp, BuiltinInterfaces.TimeMsg response_sent_timestamp, BuiltinInterfaces.TimeMsg response_received_timestamp, Sensor.CompressedImageMsg compressed_image, UC1AgentStateMsg state)
        {
        ...
        public static UC1EnvironmentResetResponse Deserialize(MessageDeserializer deserializer) => new UC1EnvironmentResetResponse(deserializer);

        private UC1EnvironmentResetResponse(MessageDeserializer deserializer)
        {
            ...
            this.state = UC1AgentStateMsg.Deserialize(deserializer);
        }
        ...
        {
            return "UC1EnvironmentResetResponse: " +
