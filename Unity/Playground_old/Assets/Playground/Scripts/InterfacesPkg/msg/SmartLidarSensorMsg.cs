...
{
    [Serializable]
    public class SmartLidarSensorMsg : Message
    {
        public const string k_RosMessageName = "interfaces_pkg/SmartLidarSensor";
        ...
        public SmartLidarSensorMsg(float angle_min, float angle_max, float angle_increment, float range_min, float range_max, float[] ranges, int[] tags)
        {
        ...
        public static SmartLidarSensorMsg Deserialize(MessageDeserializer deserializer) => new SmartLidarSensorMsg(deserializer);

        private SmartLidarSensorMsg(MessageDeserializer deserializer)
        {
